...
public class TotalPaginatedObjectTest {
    ...
    public void shouldThrowIllegalStateExceptionWhenTryingToCreatePagedObjectLargerThanSpecifiedTotal() throws Exception{
        ...
        assertThrows(IllegalStateException.class, () -> PagedObject.<String>of(listSizeLargerThan10, 2));
    }

    @Test
    public void shouldReturnTotalPagesAvailable() throws Exception{
        long totalPages = PagedObject.of(List.of(), 10).totalPages();
