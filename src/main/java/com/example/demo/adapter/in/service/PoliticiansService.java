...
public class PoliticiansService {
	...
	@Transactional
	public PagedObject<Politicians> findAllWithPage(Page page, int numberOfItemsToFetch, Long total) {
		return politiciansRepo.findAllByPage(page, numberOfItemsToFetch, total);
	}
